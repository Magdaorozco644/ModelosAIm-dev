...
qryStr = f"(SELECT [RESULT] ,[SCORE] ,[CDCHEQUE] ,[CHECK_SCORE_ID] ,[CDMAKER] ,[SYSTEM_DATE] ,[VCLCHECKBATCHID] ,[CHECKID] ,[CHECKPROPERTYID] FROM viachecks.dbo.checkreader_score) x"
