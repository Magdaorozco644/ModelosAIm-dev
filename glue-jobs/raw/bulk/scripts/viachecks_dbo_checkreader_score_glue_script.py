...
qryStr = f"(SELECT [CDCHEQUE] ,[CHECKPROPERTYID] ,[VCLCHECKBATCHID] ,[CDMAKER] ,[RESULT] ,[SYSTEM_DATE] ,[CHECK_SCORE_ID] ,[SCORE] ,[CHECKID] FROM viachecks.dbo.checkreader_score) x"
