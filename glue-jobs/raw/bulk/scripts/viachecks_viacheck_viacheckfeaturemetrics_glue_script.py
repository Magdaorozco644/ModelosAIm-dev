...
qryStr = f"(SELECT [CheckNumber] ,[Amount] ,[IdFeatureModule] ,[MetricDate] ,[Agency] ,[Routing] ,[UserName] ,[IdFeature] ,[IdVerification] ,[Account] FROM viachecks.viacheck.viacheckfeaturemetrics) x"
