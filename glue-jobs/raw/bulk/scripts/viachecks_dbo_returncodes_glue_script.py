...
qryStr = f"(SELECT [detailedReason] ,[ALERTTEMPLATE] ,[returnID] ,[returnReasonX9standar] ,[SNPREGUNTA] ,[DefaultNotify] ,[SNBLOQUEA] ,[SNMARKDEFINITIVE] ,[DSMENSAJE] ,[DSMENSAJEMOSTRARLEUSUARIO] ,[returnedCode] ,[SNBLACKLIST] FROM viachecks.dbo.returncodes) x"
