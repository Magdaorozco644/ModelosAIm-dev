...
qryStr = f"(SELECT [detailedReason] ,[SNBLACKLIST] ,[ALERTTEMPLATE] ,[returnID] ,[returnReasonX9standar] ,[returnedCode] ,[SNMARKDEFINITIVE] ,[DefaultNotify] ,[DSMENSAJEMOSTRARLEUSUARIO] ,[DSMENSAJE] ,[SNPREGUNTA] ,[SNBLOQUEA] FROM viachecks.dbo.returncodes) x"
