...
qryStr = f"(SELECT [ALERTTEMPLATE] ,[returnReasonX9standar] ,[DSMENSAJEMOSTRARLEUSUARIO] ,[detailedReason] ,[SNMARKDEFINITIVE] ,[SNPREGUNTA] ,[DSMENSAJE] ,[returnedCode] ,[returnID] ,[SNBLOQUEA] ,[SNBLACKLIST] ,[DefaultNotify] FROM viachecks.dbo.returncodes) x"
